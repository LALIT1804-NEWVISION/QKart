...
- Name: Qkart\loginSpec\cart\cart.spec.ts >> testcases 11: Empty Checkout UI state
- Location: tests\Qkart\loginSpec\cart\cart.spec.ts:107:5
...
Locator: locator('//p[contains(text(),"empty") or contains(text(),"Empty")]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('//p[contains(text(),"empty") or contains(text(),"Empty")]')
