...
test.describe("QKart Footer Links Validation", () => {
    ...
    test("TC_003 Verify that the Privacy Policy link displayed in the footer section of the Home Page opens in a new browser tab and navigates successfully",
        async ({ appAction }) => {
            await appAction.login.login(loginData.LoginDetails.Username, loginData.LoginDetails.Password);
    ...
    test("TC_004 Verify that the About Us link displayed in the footer section of the Home Page opens in a new browser tab and navigates successfully",
        async ({ appAction }) => {
            await appAction.login.login(loginData.LoginDetails.Username, loginData.LoginDetails.Password);
    ...
    test("TC_005 Verify that the Contact Us link displayed in the footer section of the Home Page opens the Contact Us popup successfully",
        async ({ appAction }) => {
            await appAction.login.login(loginData.LoginDetails.Username, loginData.LoginDetails.Password);
    ...
    test("TC_006 Verify that the Terms of Service link displayed in the footer section of the Home Page opens in a new browser tab and navigates successfully",
        async ({ appAction }) => {
            await appAction.login.login(loginData.LoginDetails.Username, loginData.LoginDetails.Password);
