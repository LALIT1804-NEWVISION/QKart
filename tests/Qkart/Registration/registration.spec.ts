...
test.describe("SC_001_Registration Functionality Validation", () => {
  ...
  test("REG_002 - Verify Registration with Existing Username", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
...
test.describe("SC_002_Mandatory Field Validation", () => {
  test("REG_003 - Verify Error Message for Blank Username Field", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
  ...
  test("REG_004 - Verify Error Message for Blank Password Field", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
  ...
  test("REG_005 - Verify Error Message for All Blank Fields", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
...
test.describe("SC_003_Field Length Validation", () => {
  test("REG_006 - Verify Username Minimum Length Validation", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
  ...
  test("REG_007 - Verify Password Minimum Length Validation", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
...
test.describe("SC_004_Password Validation", () => {
  test("REG_008 - Verify Password and Confirm Password Mismatch", async ({appAction}) => {
    await appAction.register.Click_On_RegisterLink();
