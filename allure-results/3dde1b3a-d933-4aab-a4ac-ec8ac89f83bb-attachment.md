...
Locator: locator('//div[text()=\'Order total\']')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('//div[text()=\'Order total\']')
...
```ts
  ...
  180 |         await this.loginPage.loginLink.click()
  181 |         await this.loginPage.username.fill(username);
  182 |         await this.loginPage.passwrod.fill(password);
> 183 |         await expect(this.loginPage.Ordertotal).toBeVisible()
      |                                                 ^ Error: expect(locator).toBeVisible() failed
  184 |     }   
  185 | }
  186 | 
