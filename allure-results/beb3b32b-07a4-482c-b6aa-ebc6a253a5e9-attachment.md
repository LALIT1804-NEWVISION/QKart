...
- Location: tests\Qkart\loginSpec\cart\cart.spec.ts:85:9
...
Locator: getByText('Cart is empty. Add more items to the cart to checkout.')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Cart is empty. Add more items to the cart to checkout.')
