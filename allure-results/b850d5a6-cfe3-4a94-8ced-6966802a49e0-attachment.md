...
- Location: tests\Qkart\loginSpec\cart\cart.spec.ts:86:9
...
```ts
  ...
  83 | });
  84 | 
  85 | // Test 10: Empty cart - bypasses authentication
  86 | baseTest("testcases 10: Empty Checkout UI state", async ({ page }) => {
