...
- Name: Qkart\Registration\registration.spec.ts >> Registration Functionality >> REG_001 - Verify Registration with Valid Details
- Location: tests\Qkart\Registration\registration.spec.ts:4:7
...
```ts
  14  |   async Click_On_RegisterLink() {
  15  |     await this.registerationPage.registerLink.click();
  16  |   }
  17  | 
