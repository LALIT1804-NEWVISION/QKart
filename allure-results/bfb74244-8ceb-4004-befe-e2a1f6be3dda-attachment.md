...
Locator: getByText('Contact Us')
Expected: visible
Error: strict mode violation: getByText('Contact Us') resolved to 2 elements:
    1) <p class="footer-text">Contact us</p> aka getByText('Contact us', { exact: true })
    2) <h3 class="text-center contact-us">Contact Us</h3> aka getByRole('heading', { name: 'Contact Us' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Contact Us')
...
- generic [ref=e1]:
        ...
        - list [ref=e174]:
          - listitem [ref=e175]:
            - button [disabled]:
              - img
          - listitem [ref=e176]:
            - button [ref=e177] [cursor=pointer]: "1"
          - listitem [ref=e178]:
            - button [ref=e179] [cursor=pointer]: "2"
          - listitem [ref=e180]:
  ...
  - dialog [ref=e206]:
    - generic [ref=e213]:
      - generic [ref=e215]:
        - heading [level=3]
        - generic [ref=e216] [cursor=pointer]: X
        - heading "Contact Us" [level=3] [ref=e217]
        - heading "(we generally respond in 24 hours)" [level=6] [ref=e218]
      - generic [ref=e219]:
        - textbox "Name" [ref=e222]
        - textbox "Email" [ref=e225]
      - textbox "Message" [ref=e227]
      - button "Contact Now" [ref=e230] [cursor=pointer]: Contact Now
```
