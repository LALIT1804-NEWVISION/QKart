...
- Name: Qkart\loginSpec\login.spec.ts >> Login_09 Verify login with leading spaces in username and password
- Location: tests\Qkart\loginSpec\login.spec.ts:64:5
