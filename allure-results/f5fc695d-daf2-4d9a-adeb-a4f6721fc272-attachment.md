...
- Name: Qkart\loginSpec\cart\cart.spec.ts >> testcases 01: Add product to Checkout 
- Location: tests\Qkart\loginSpec\cart\cart.spec.ts:6:5
...
Locator: locator('//button[text()="Checkout"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('//button[text()="Checkout"]')
