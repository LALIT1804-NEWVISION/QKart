...
- Name: Qkart\cart\cart.spec.ts >> TC 043: Add Same Item again
- Location: tests\Qkart\cart\cart.spec.ts:27:5
...
- generic [ref=e4]:
  ...
  - generic [ref=e14]:
    ...
    - paragraph [ref=e26]:
      ...
      - link "Register now" [ref=e27] [cursor=pointer]:
        - /url: /register
  - generic [ref=e28]:
    - img "QKart-icon" [ref=e30]
    - paragraph [ref=e31]: QKart is your one stop solution to the buy the latest trending items with India 's Fastest Delivery to your doorstep
    - generic [ref=e32]:
      - paragraph [ref=e33] [cursor=pointer]:
        - link "Privacy policy" [ref=e34]:
          - /url: privacy-policy
      - paragraph [ref=e35] [cursor=pointer]:
        - link "About us" [ref=e36]:
          - /url: aboutus
      - paragraph [ref=e37] [cursor=pointer]: Contact us
