...
```ts
  ...
  69 |     await page.goto("https://crio-qkart-frontend-qa.vercel.app");
  70 |     await page.locator('//p[normalize-space()="Roadster Mens Running Shoes"]/../following-sibling::div//button[.="Add to cart"]').click();
> 71 |     await expect(page.locator('//div[contains(text(),"Login to add")]')).toBeVisible();
     |                                                                          ^ Error: expect(locator).toBeVisible() failed
  72 | });
  73 | 
